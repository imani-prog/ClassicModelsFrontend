                ...
                {editPayment && (
                    <form onSubmit={handleEditSave}>
                        ...
                        <div className="grid grid-cols-2 gap-2 items-center">
                            ...
                            <input name="date" value={editPayment.date} onChange={handleEditInput} required className="border p-2 rounded w-full" placeholder="Date (YYYY-MM-DD)" />
                        </div>
            ...
            <Modal open={addModalOpen} onClose={() => setAddModalOpen(false)}>
                <form onSubmit={e => {
                    ...
                    <div className="grid grid-cols-2 gap-2 items-center">
                        ...
                        <span className="font-semibold text-right pr-2">Date:</span>
                        <input name="date" value={addForm.date} onChange={e => setAddForm(f => ({ ...f, date: e.target.value }))} required className="border p-2 rounded w-full" placeholder="Date (YYYY-MM-DD)" />
                    </div>
                    <div className="flex gap-2 mt-4">
